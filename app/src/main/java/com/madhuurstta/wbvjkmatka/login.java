...
//            //whatsappReset.setVisibility(View.VISIBLE);
//        } else {
//
//        }
        ...
        findViewById(R.id.whatsapp_img).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void initViews() {
        ...
        whatsappReset = findViewById(R.id.whatsapp_reset);
    }
}
